...
const puppeteer = require('puppeteer'); // Import Puppeteer for browser automation (no need for puppeteer-core)
...
app.post('/analyze', async (req, res) => {
    ...
    try {
        ...
        const browser = await puppeteer.launch({
            ...
            executablePath: puppeteer.executablePath() // Automatically handle Chromium installation
        });
